...
import com.uas.catatanharian.adapter.NotesRecycleViewAdapter;
import com.uas.catatanharian.model.Note;
import com.uas.catatanharian.Config;
import com.uas.catatanharian.MainActivity;
...
public class DetailNotesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get list category
        DB = FirebaseDatabase.getInstance(Config.getDB_URL()).getReference("catatanharian/" + Auth.getUid() + "/" + this.category);
